...
In 2003, I suported an neuroimaging analysis pipeline at Berkeley's Brain Imaging Center that was an _ad hoc_ collection of MATLAB toolboxes, IDL routines, C/C++ programs, AWK scripts, and shell glue that nobody fully understood.
Results from our lab and others were difficult to verify.
...
Rather than accepting either a single-owner tool or an _ad hoc_ pipeline, we set out to build a community-owned neuroimaging platform in Python that would make analyses scriptable from raw data and invite contributors from beyond a single lab.
...
When we began working on NIPY, scientific Python was taking shape around Numeric, but the ecosystem was not yet coherent.
...
By the end of the second decade we faced a new problem: there was no longer anyone with the mandate, or the mechanism, to hold the ecosystem together.
...
## Scientific Python Coordination
...
- In 2024, I became the Executive Director for the Berkeley Open Source Program Office
  - OSPO purpose https://ospo-berkeley-edu.netlify.app/
- In 2024, Fernando became the Faculty Director for BIDS, where Stefan and I work: https://bids.berkeley.edu/news/berkeley-institute-data-science-appoints-fernando-p%C3%A9rez-next-faculty-directo
  - directors vision https://bids.berkeley.edu/about/directors-vision-2024
- In 2025, Kirstie became BIDS Executive Director https://cdss.berkeley.edu/news/meet-kirstie-whitaker-new-executive-director-bids
- In 2025, Min Ragan-Kelley joined BIDS as Senior Open Infrastructure Architect
