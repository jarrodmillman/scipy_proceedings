...
Why did two of the most consequential projects in scientific computing---the scientific Python ecosystem and Jupyter---have roots inside a neuroimaging lab at Berkeley that was not, on paper, in the software business at all?

The answer has much to do with how Mark D'Esposito ran his lab.
Mark was interested in more than his own lab's output; he wanted good people in the lab producing work that would benefit the broader scientific community, and he trusted competent researchers enough to let them pursue what they judged important, even when it drifted far from any specific study or grant.
That trust is what let Matthew, Fernando Pérez, and me spend real time on scientific Python and, later, Jupyter, work that was not in any of our job descriptions and that did not, on its own, advance the neuroimaging questions the lab was ostensibly funded to answer.
...
Being embedded in a neuroimaging lab rather than a software lab shaped the work in a way that mattered more than it might seem.
Our colleagues were neuroscientists, not programmers, so anything we built had to be installable, learnable, and usable by people who had no interest in becoming expert software developers.
...
The same instinct is written into our neuroimaging collaboration's mission statement, drafted in the project's early years:
...
Being on a large public university campus, rather than isolated inside a single lab or company, did the complementary work of keeping us honest.
...
It also connected us to campus-wide conversations about open science and reproducibility that were happening well outside any one department, so the problems we were solving locally were visibly the same problems other fields were running into.

Seen this way, the first two lessons look different in hindsight.
Shared rooms mattered in 2005 not because co-location is inherently better than a mailing list, but because the people in that room had been given the freedom and the trust to spend real time on a shared problem, in the same way Mark gave Matthew, Fernando, and me room to spend time on scientific Python instead of narrowly on neuroimaging results.
The scikits' departure and the conference's growth were not fragmentation for its own sake either; they were what happens when that same freedom is extended across domains, as astronomers, neuroimagers, and statisticians were each given room to shape tools around their own questions rather than having one group's priorities imposed on all of them.
Coordination, proceedings, BIDS, and the OSPO are all real, and all necessary---but none of them explain why any of this started, why it grew, or why it has lasted for nearly three decades.
The explanation is closer to what let Matthew, Fernando, and me spend years on tools that were not in our job descriptions: someone, somewhere, chose to trust capable people with room to decide what mattered, and did not demand that the value of that work be justified in advance.

But Matthew, Fernando, and I were lucky, and it would be dishonest to end this lesson as though our experience were the norm.
...
Many could not sustain that position indefinitely and left for industry, where the demands of a job rarely leave room for the kind of unstructured, long-horizon tinkering that built numpy, scipy, and Jupyter in the first place---and once they left, the ecosystem typically lost not just their labor but their capacity to keep contributing at all.
The freedom that made this possible was never distributed evenly, and a great deal of this ecosystem was built by people paying, personally, for a trust their own institutions were unwilling to extend.
...
This ecosystem lasted because some people were trusted with room to decide what mattered and time to work on it. It has also lost contributors, and capacity, because that trust was never extended widely or durably enough. Making it durable is the work still ahead.
:::
