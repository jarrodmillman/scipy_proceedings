...
Fernando returned in 2024 to lead it as Faculty Director, a decade after co-founding it; Stéfan and Min work there on the technical and infrastructure side; Kirstie Whitaker, the graduate student whose career had once been redirected by a conversation with Fernando, returned in 2025 as BIDS's Executive Director; and I lead Berkeley's Open Source Program Office from within it: each of us arriving by a different route, at a different time, back to the same institution.
...
A diaspora that distributes ownership across many projects and domains is productive until the shared vision that held the ecosystem together can no longer be carried across project boundaries, and domain-specific solutions start duplicating work that belongs to everyone.
...
:::{important} Coordinate by consensus, not authority.
When distributed ownership stops scaling,
shared standards and cross-project summits
hold the ecosystem together without recentralizing it.
:::

Coordination alone does not explain why this ecosystem has lasted.
People who build open scientific infrastructure do not stay in one place, and the community's knowledge does not stay put either; it travels through universities, companies, national labs, and research institutes, and it decays wherever it stops being taught.
What brought Fernando, Stéfan, Min, Kirstie, and me to BIDS was not that a university manages software better than a company does, but that reproducibility and teaching are academic concerns, and only an institution built around those obligations can keep them alive across generations of students and researchers.
Industry partners contribute tools, compute, and engineering talent, and the ecosystem depends on that contribution; but the multi-owner argument this paper opened with in 2003---that no single lab, company, or institution should hold the ecosystem's future---only means something if someone remains accountable for handing that ecosystem to the next generation, which is the role a university, at its best, is obligated to play.

:::{important} Anchor in institutions that depend on it.
Reproducibility and teaching are academic concerns.
Scientific software development and maintenance belongs
in institutions accountable to those goals.
:::
