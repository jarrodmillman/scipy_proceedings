...
In 2003, I supported an neuroimaging analysis pipeline at Berkeley's Brain Imaging Center that was an _ad hoc_ collection of MATLAB toolboxes, IDL routines, C/C++ programs, AWK scripts, and shell glue that nobody fully understood.
...
- In 2024, Fernando became the Faculty Director for BIDS, where Stéfan and I work: https://bids.berkeley.edu/news/berkeley-institute-data-science-appoints-fernando-p%C3%A9rez-next-faculty-directo
